...
/* #endif */
        ...
        byteOut = out;
        /*
         * PATCH(j2me-nx-port) 2026-09-23：System.out/err 固定用 **UTF-8**，不跟
         * microedition.encoding 走。原因：宿主的日志文件（sdmc:/switch/j2me-nx/error.log）
         * 是 UTF-8，而 Java 侧的诊断行（[textinput] / [samsung] / [font-probe] …）全靠它
         * 才看得懂。默认编码改成 GBK 之后（见 vendor/pluotsorbet/native.js 的同日补丁），
         * 这里若还用默认编码，日志里所有 Java 中文会变成乱码 —— 等于把排查手段砸了。
         */
