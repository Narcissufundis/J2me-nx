  ...
  export class Context {
    ...
    execute() {
      ...
      try {
        ...
        if ((<any>e).classInfo) {
          e = (<any>e).classInfo.getClassNameSlow() + ": " + fromStringAddr((<any>e).detailMessage);
        }
        throw e;
      }
...
// PATCH(j2me-nx-port): configurable 必须为 true——软重启会重新求值整个
// bundle，不可重定义的全局属性会让第二次求值直接 TypeError。
