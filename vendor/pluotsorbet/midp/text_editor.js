...
var TextEditorProvider = (function() {
    ...
    var CommonEditorPrototype = {
        ...
        setFont: function(fontAddr) {
            ...
            // PATCH(j2me-nx-port): ctx.font getter 坏（读回 undefined），用 fontCss
            this._setStyle("font", this.fontContext.fontCss || this.fontContext.font);
        },
    ...
    TextAreaEditor.prototype = extendsObject({
        ...
        getContentHeight: function() {
            ...
            div.style.setProperty("font", this.fontContext.fontCss || this.fontContext.font); // PATCH: 坏 getter
